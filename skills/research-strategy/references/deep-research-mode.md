...
- Use multi-pass retrieval: broad discovery, focused verification, and contradiction checks across built-in web search and MCP providers.
...
1. Run initial broad searches with built-in web search and at least one MCP provider.
