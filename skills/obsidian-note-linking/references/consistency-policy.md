...
6. **Navigation block**: keep a fixed footer section for previous/next/related links, but match the vault's existing heading language and label convention in generated output.
...
- Keep sequence navigation headings and labels consistent and match the vault's dominant language or existing label convention.
...
- If the vault language or existing notes indicate non-English navigation labels, preserve that language instead of defaulting to English.
